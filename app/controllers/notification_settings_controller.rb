class NotificationSettingsController < ApplicationController
    ...
    def update
        ...
        @notification.update( setting_config_params: {"count": params[:comment_count], "within":params[:comment_duration]}, by_phone: params[:comment_count_by_phone] == "1", by_email: params[:comment_count_by_email]  == "1"  )
